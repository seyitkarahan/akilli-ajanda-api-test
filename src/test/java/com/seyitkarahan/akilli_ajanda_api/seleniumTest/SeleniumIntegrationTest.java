...
public class SeleniumIntegrationTest {
    ...
    public void testSuccessfulLogin() {
        ...
        wait.until(ExpectedConditions.not(ExpectedConditions.titleIs("Giriş Yap")));
    }
    ...
    public void testSuccessfulRegistration() {
        ...
        // Her testte benzersiz bir email kullanmak için
        ...
        // 3. Kayıt ol butonunu bul ve tıkla
        WebElement registerButton = driver.findElement(By.cssSelector("button[type='submit']"));
        registerButton.click();

        // 4. Başarılı kayıt sonrası Dashboard'a yönlendirildiğini doğrula
